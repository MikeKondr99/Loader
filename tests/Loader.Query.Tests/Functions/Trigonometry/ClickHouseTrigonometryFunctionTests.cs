...
public sealed class ClickHouseTrigonometryFunctionTests : ClickHouseExpressionTestBase
{
    ...
    [Test]
    [Arguments("Acos(-1)", 3.141592653589793)]
    [Arguments("Acos(TestDec(-1, 18, 2))", 3.141592653589793)]
    ...
    [Arguments("Acos(null)", null)]
    [Arguments("Asin(0)", 0.0)]
    [Arguments("Asin(TestDec(0, 18, 2))", 0.0)]
    ...
    [Arguments("Asin(null)", null)]
    [Arguments("Atan(0)", 0.0)]
    [Arguments("Atan(TestDec(0, 18, 2))", 0.0)]
    [Arguments("Atan(1)", 0.7853981633974483)]
    [Arguments("Atan(null)", null)]
    [Arguments("Atan2(1, 1)", 0.7853981633974483)]
    [Arguments("Atan2(TestDec(1, 18, 2), TestDec(1, 18, 2))", 0.7853981633974483)]
    [Arguments("Atan2(1, -1)", 2.356194490192345)]
    [Arguments("Atan2(-1, -1)", -2.356194490192345)]
    [Arguments("Atan2(null, 1)", null)]
    [Arguments("Atan2(1, null)", null)]
    ...
    [Arguments("Cosh(TestDec(0, 18, 2))", 1.0)]
    [Arguments("Cosh(1)", 1.5430806348152437)]
    [Arguments("Cosh(-1)", 1.5430806348152437)]
    [Arguments("Cosh(null)", null)]
    [Arguments("Sinh(0)", 0.0)]
    [Arguments("Sinh(TestDec(0, 18, 2))", 0.0)]
    [Arguments("Sinh(1)", 1.1752011936438014)]
    [Arguments("Sinh(-1)", -1.1752011936438014)]
    [Arguments("Sinh(null)", null)]
    [Arguments("Tanh(0)", 0.0)]
    [Arguments("Tanh(TestDec(0, 18, 2))", 0.0)]
    [Arguments("Tanh(1)", 0.7615941559557649)]
    [Arguments("Tanh(-1)", -0.7615941559557649)]
    [Arguments("Tanh(100)", 1.0)]
    [Arguments("Tanh(null)", null)]
    ...
    [Arguments("Acosh(TestDec(1, 18, 2))", 0.0)]
    [Arguments("Acosh(2)", 1.3169578969248166)]
    [Arguments("Acosh(0.5)", null)]
    [Arguments("Acosh(-1)", null)]
    [Arguments("Acosh(null)", null)]
    [Arguments("Asinh(0)", 0.0)]
    [Arguments("Asinh(TestDec(0, 18, 2))", 0.0)]
    [Arguments("Asinh(1)", 0.881373587019543)]
    [Arguments("Asinh(-1)", -0.881373587019543)]
    [Arguments("Asinh(null)", null)]
    [Arguments("Atanh(0)", 0.0)]
    [Arguments("Atanh(TestDec(0, 18, 2))", 0.0)]
