...
public sealed class ClickHouseColorFunctionTests : ClickHouseExpressionTestBase
{
    ...
    [Arguments("Rgb(256, 0, 0)", 0xFFFF0000L)]
    [Arguments("Rgb(257, 2, 3)", 0xFFFF0203L)]
    [Arguments("Rgb(-1, 0, 0)", 0xFF000000L)]
    [Arguments("Rgb(0, -1, 0)", 0xFF000000L)]
    [Arguments("Rgb(0, 0, -1)", 0xFF000000L)]
