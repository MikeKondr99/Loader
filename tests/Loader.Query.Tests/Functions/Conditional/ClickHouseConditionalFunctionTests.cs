...
public sealed class ClickHouseConditionalFunctionTests : ClickHouseExpressionTestBase
{
    ...
    [Arguments("2.Alt(3)", 2)]
    [Arguments("TestDec(2.5, 18, 2).Alt(TestDec(3.5, 18, 2))", 2.5)]
    [Arguments("TestDec(2.5, 18, 2).Alt(3.5)", 2.5)]
    [Arguments("2.5.Alt(TestDec(3.5, 18, 2))", 2.5)]
    ...
    [Arguments("Case(true, TestDec(3.14, 18, 2))", 3.14)]
    ...
    [Arguments("Case(TestDec(3.14, 18, 2), true, TestDec(2.71, 18, 2))", 3.14)]
    [Arguments("Case(TestDec(3.14, 18, 2), true, 2.71)", 3.14)]
    [Arguments("Case(null, true, TestDec(2.71, 18, 2))", 2.71)]
    [Arguments("Case(3.14, true, TestDec(2.71, 18, 2))", 3.14)]
