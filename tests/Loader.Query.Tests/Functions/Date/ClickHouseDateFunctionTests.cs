...
public sealed class ClickHouseDateFunctionTests : ClickHouseExpressionTestBase
{
    ...
    [Arguments("Date(2106)", "@2106-01-01 00:00:00")]
    [Arguments("Date(0)", null)]
    [Arguments("Date(1)", null)]
    [Arguments("Date(99)", null)]
    [Arguments("Date(999)", null)]
    [Arguments("Date(1969)", null)]
    [Arguments("Date(2107)", null)]
    [Arguments("Date(2023, 5)", "@2023-05-01 00:00:00")]
    [Arguments("Date(2024, 2)", "@2024-02-01 00:00:00")]
    [Arguments("Date(1969, 12)", null)]
    [Arguments("Date(2107, 1)", null)]
    [Arguments("Date(2026, 13)", null)]
    [Arguments("Date(2026, 0)", null)]
    [Arguments("Date(2023, 5, 15)", "@2023-05-15 00:00:00")]
    [Arguments("Date(2024, 2, 29)", "@2024-02-29 00:00:00")]
    [Arguments("Date(1969, 12, 31)", null)]
    [Arguments("Date(2107, 1, 1)", null)]
    [Arguments("Date(2026, 13, 1)", null)]
    [Arguments("Date(2026, 1, 32)", null)]
    [Arguments("Date(2026, 2, 29)", null)]
