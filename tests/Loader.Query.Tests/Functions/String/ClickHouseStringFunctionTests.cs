...
public sealed class ClickHouseStringFunctionTests : ClickHouseExpressionTestBase
{
    ...
    [Arguments("PadLeft('abc', 2)", "abc")]
    [Arguments("PadLeft('abcdef', 3)", "abcdef")]
    ...
    [Arguments("PadRight('abc', 2)", "abc")]
    [Arguments("PadRight('abcdef', 3)", "abcdef")]
    ...
    [Arguments("PadLeft('abc', 3, '*')", "abc")]
    [Arguments("PadLeft('abc', 2, '*')", "abc")]
    [Arguments("PadLeft('abcdef', 3, '0')", "abcdef")]
    [Arguments("PadLeft('abc', 0, '*')", "")]
    [Arguments("PadLeft('', 5, '-')", "-----")]
    ...
    [Arguments("PadRight('abc', 3, '*')", "abc")]
    [Arguments("PadRight('abc', 2, '*')", "abc")]
    [Arguments("PadRight('abcdef', 3, '0')", "abcdef")]
    [Arguments("PadRight('abc', 0, '*')", "")]
    [Arguments("PadRight('', 5, '-')", "-----")]
    ...
    [Arguments("Left('Hello World!',20)", "Hello World!")]
    [Arguments("Left('Hello World!',0)", "")]
    [Arguments("Left('Hello World!',-1)", "")]
    [Arguments("Left('Привет мир!',6)", "Привет")]
    [Arguments("Left('😀👍👋',2)", "😀👍")]
    [Arguments("Left(null,5)", null)]
    [Arguments("Left('Hello World!',null)", null)]
    [Arguments("Right('Hello World!',6)", "World!")]
    [Arguments("Right('Hello World!',20)", "Hello World!")]
    [Arguments("Right('Hello World!',0)", "")]
    [Arguments("Right('Hello World!',-1)", "")]
    [Arguments("Right('Привет мир!',4)", "мир!")]
    [Arguments("Right('😀👍👋',2)", "👍👋")]
    [Arguments("Right(null,5)", null)]
    [Arguments("Right('Hello World!',null)", null)]
    [Arguments("Mid('Hello World!',1)", "Hello World!")]
    [Arguments("Mid('Hello World!',5)", "o World!")]
    [Arguments("Mid('Hello World!',12)", "!")]
    [Arguments("Mid('Hello World!',13)", "")]
    [Arguments("Mid('Hello World!',5,3)", "o W")]
    [Arguments("Mid('Hello World!',1,5)", "Hello")]
    [Arguments("Mid('Hello World!',5,0)", "")]
    [Arguments("Mid('Hello World!',5,-1)", "")]
    [Arguments("Mid('Привет мир!',1)", "Привет мир!")]
    [Arguments("Mid('Привет мир!',3)", "ивет мир!")]
    [Arguments("Mid('Привет мир!',3,4)", "ивет")]
    [Arguments("Mid('😀👍👋',2)", "👍👋")]
    [Arguments("Mid('😀👍👋',2,1)", "👍")]
    [Arguments("Mid('a😀b👍c',2,3)", "😀b👍")]
    [Arguments("Mid(null,1)", null)]
    [Arguments("Mid('Hello World!',null)", null)]
    [Arguments("Mid(null,1,3)", null)]
    [Arguments("Mid('Hello World!',1,null)", null)]
    public Task FuncLeftRightMidTests(string expr, object? expected)
    {
        return AssertExpressionAsync(expr, expected);
    }
