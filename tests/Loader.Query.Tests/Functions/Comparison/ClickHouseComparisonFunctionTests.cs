...
public sealed class ClickHouseComparisonFunctionTests : ClickHouseExpressionTestBase
{
    ...
    [Arguments("TestDec(1.3, 18, 2) < TestDec(1.5, 18, 2)", true)]
    [Arguments("TestDec(1.3, 18, 2) < 1.5", true)]
    [Arguments("1.3 < TestDec(1.5, 18, 2)", true)]
    ...
    [Arguments("TestDec(1.5, 18, 2) > TestDec(1.3, 18, 2)", true)]
    [Arguments("TestDec(1.5, 18, 2) > 1.3", true)]
    [Arguments("1.5 > TestDec(1.3, 18, 2)", true)]
    ...
    [Arguments("5 = 10", false)]
    [Arguments("1.5 = 1.5", true)]
    [Arguments("TestDec(1.5, 18, 2) = TestDec(1.5, 18, 2)", true)]
    [Arguments("TestDec(1.5, 18, 2) = 1.5", true)]
    [Arguments("1.5 = TestDec(1.5, 18, 2)", true)]
    [Arguments("1.5 = 1.3", false)]
    ...
    [Arguments("TestDec(1.5, 18, 2).Between(TestDec(1.0, 18, 2), TestDec(2.0, 18, 2))", true)]
    [Arguments("TestDec(1.5, 18, 2).Between(1.0, 2.0)", true)]
    [Arguments("1.5.Between(TestDec(1.0, 18, 2), TestDec(2.0, 18, 2))", true)]
