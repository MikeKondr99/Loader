...
- [ ] Опция `header` должна быть строго boolean, но сейчас ошибка типа опции идет без `LangSpan`; нужно хранить span option/value и возвращать доменную ошибку с позицией.
